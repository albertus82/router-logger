...
![Screenshot](https://cloud.githubusercontent.com/assets/8672431/15990840/71d15b26-30a0-11e6-8e52-112e110444e3.png)
...
* **`email.max.queue.size`**= dimensione massima della coda delle email (default: `50` messaggi). Quando un messaggio non pu&ograve; essere inviato per assenza di rete o per superamento del numero massimo di email che possono essere inviate contemporaneamente, esso viene messo in una coda. Valori eccessivi possono causare un'elevata occupazione di memoria.
