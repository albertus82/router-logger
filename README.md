...
* **`gui.clipboard.max.chars`**= dimensione massima degli appunti, in caratteri. Dimensioni eccessive possono causare un'elevata occupazione di memoria (default: `100000` caratteri).
