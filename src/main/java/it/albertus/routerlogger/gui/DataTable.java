...
import it.albertus.routerlogger.gui.listener.CopyDataTableSelectionListener;
import it.albertus.routerlogger.gui.listener.DataTableContextMenuDetectListener;
import it.albertus.routerlogger.gui.listener.DeleteDataTableSelectionListener;
import it.albertus.routerlogger.gui.listener.SelectAllDataTableSelectionListener;
...
public class DataTable {
	...
	private static final RouterLoggerConfig configuration = RouterLoggerConfig.getInstance();
	...
	private final DateFormat dateFormatTable = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss.SSS");
