...
import static it.albertus.routerlogger.gui.preference.page.PageDefinition.APPEARANCE;
import static it.albertus.routerlogger.gui.preference.page.PageDefinition.APPEARANCE_TABLE;
import static it.albertus.routerlogger.gui.preference.page.PageDefinition.CONSOLE;
import static it.albertus.routerlogger.gui.preference.page.PageDefinition.CSV;
import static it.albertus.routerlogger.gui.preference.page.PageDefinition.DATABASE;
import static it.albertus.routerlogger.gui.preference.page.PageDefinition.EMAIL;
import static it.albertus.routerlogger.gui.preference.page.PageDefinition.EMAIL_ADVANCED;
import static it.albertus.routerlogger.gui.preference.page.PageDefinition.EMAIL_CC_BCC;
import static it.albertus.routerlogger.gui.preference.page.PageDefinition.GENERAL;
import static it.albertus.routerlogger.gui.preference.page.PageDefinition.LOGGING;
import static it.albertus.routerlogger.gui.preference.page.PageDefinition.MQTT;
import static it.albertus.routerlogger.gui.preference.page.PageDefinition.MQTT_ADVANCED;
import static it.albertus.routerlogger.gui.preference.page.PageDefinition.MQTT_MESSAGES;
import static it.albertus.routerlogger.gui.preference.page.PageDefinition.READER;
import static it.albertus.routerlogger.gui.preference.page.PageDefinition.READER_ASUS_N12E;
import static it.albertus.routerlogger.gui.preference.page.PageDefinition.READER_ASUS_N14U;
import static it.albertus.routerlogger.gui.preference.page.PageDefinition.READER_DLINK_2750;
import static it.albertus.routerlogger.gui.preference.page.PageDefinition.READER_TPLINK_8970;
...
import it.albertus.routerlogger.gui.TrayIcon;
...
import it.albertus.routerlogger.http.json.AbstractJsonHandler;
...
public enum Preference implements IPreference {
	...
	DATABASE_COLUMN_NAME_PREFIX(new PreferenceDetailsBuilder(DATABASE).defaultValue(DatabaseWriter.Defaults.COLUMN_NAME_PREFIX).build(), new FieldEditorDetailsBuilder(EnhancedStringFieldEditor.class).emptyStringAllowed(true).build()),
	DATABASE_COLUMN_NAME_MAX_LENGTH(new PreferenceDetailsBuilder(DATABASE).defaultValue(DatabaseWriter.Defaults.COLUMN_NAME_MAX_LENGTH).build(), new FieldEditorDetailsBuilder(EnhancedIntegerFieldEditor.class).textLimit(2).numberMinimum(DatabaseWriter.COLUMN_NAME_MIN_LENGTH).build()),
	...
	SERVER_MAXRSPTIME(new PreferenceDetailsBuilder(SERVER).defaultValue(HttpServerConfig.DEFAULT_MAX_RSP_TIME).restartRequired().parent(SERVER_ENABLED).build(), new FieldEditorDetailsBuilder(ShortComboFieldEditor.class).numberValidRange(-1, Short.MAX_VALUE).labelsAndValues(new LocalizedLabelsAndValues(new Localized() {
		@Override
		public String getString() {
	...
	SERVER_LOG_INCLUDE_STATIC(new PreferenceDetailsBuilder(SERVER).defaultValue(RootHtmlHandler.Defaults.LOG_INCLUDE_STATIC).parent(SERVER_ENABLED).build(), new FieldEditorDetailsBuilder(DefaultBooleanFieldEditor.class).build()),
	...
	SERVER_SSL_HSTS_MAXAGE(new PreferenceDetailsBuilder(SERVER_HTTPS_ADVANCED).defaultValue(HttpServerConfig.DEFAULT_SSL_HSTS_MAX_AGE).parent(SERVER_SSL_HSTS_ENABLED).build(), new FieldEditorDetailsBuilder(IntegerComboFieldEditor.class).labelsAndValues(ServerHttpsAdvancedPreferencePage.getHSTSMaxAgeComboOptions()).build()),
	...
	SERVER_SSL_REDIRECTION_LOCATION_HOST(new PreferenceDetailsBuilder(SERVER_HTTPS_ADVANCED).defaultValue(RedirectionServerConfig.DEFAULT_SSL_REDIRECTION_LOCATION_HOST).parent(SERVER_SSL_REDIRECTION_ENABLED).build(), new FieldEditorDetailsBuilder(ValidatedComboFieldEditor.class).boldCustomValues(false).emptyStringAllowed(false).labelsAndValues(new LocalizedLabelsAndValues(new ISupplier<String>() {
		@Override
		public String get() {
	...
	LOGGING_LEVEL(new PreferenceDetailsBuilder(LOGGING).defaultValue(RouterLoggerConfig.Defaults.LOGGING_LEVEL.getName()).build(), new FieldEditorDetailsBuilder(DefaultComboFieldEditor.class).labelsAndValues(LoggingPreferencePage.getLoggingLevelComboOptions()).build()),
	...
	LOGGING_EMAIL_LEVEL(new PreferenceDetailsBuilder(LOGGING).defaultValue(EmailHandler.Defaults.LEVEL.getName()).parent(LOGGING_EMAIL_ENABLED).build(), new FieldEditorDetailsBuilder(DefaultComboFieldEditor.class).labelsAndValues(LoggingPreferencePage.getLoggingLevelComboOptions(EmailHandler.MIN_LEVEL, EmailHandler.MAX_LEVEL)).build()),
