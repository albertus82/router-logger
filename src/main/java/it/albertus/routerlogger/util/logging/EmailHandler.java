...
@ExcludeLoggers({ "javax.mail", "it.albertus.routerlogger.email", "it.albertus.routerlogger.util.logging" })
public class EmailHandler extends AnnotationConfigHandler {
	...
	public void publish(final LogRecord record) {
		...
		try {
			...
			if (thrown == null || lastThrownSent == null || !RouterLoggerConfig.getInstance().getBoolean("logging.email.ignore.duplicates", Defaults.IGNORE_DUPLICATES) || !Arrays.equals(lastThrownSent.getStackTrace(), thrown.getStackTrace())) {
