...
@Path("/js/" + JQueryJsHandler.RESOURCE_NAME)
public class JQueryJsHandler extends StaticResourceHandler {

	protected static final String RESOURCE_NAME = "jquery.min.js";

	public JQueryJsHandler() {
