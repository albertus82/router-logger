...
public enum Preference implements IPreference {
	...
	LOG_EMAIL_IGNORE_DUPLICATES(Page.GENERAL, FieldEditorType.DefaultBoolean, Boolean.toString(Logger.Defaults.EMAIL_IGNORE_DUPLICATES), null, LOG_EMAIL),
	...
	GUI_TABLE_COLUMNS_PADDING_RIGHT(Page.APPEARANCE, FieldEditorType.ScaleInteger, Byte.toString(DataTable.Defaults.COLUMNS_PADDING_RIGHT), new FieldEditorDataBuilder().scaleMaximum(Byte.MAX_VALUE).scalePageIncrement(10).build()),
	...
	GUI_MINIMIZE_TRAY(Page.APPEARANCE, FieldEditorType.DefaultBoolean, Boolean.toString(TrayIcon.Defaults.GUI_MINIMIZE_TRAY)),
	GUI_TRAY_TOOLTIP(Page.APPEARANCE, FieldEditorType.DefaultBoolean, Boolean.toString(TrayIcon.Defaults.GUI_TRAY_TOOLTIP), null, GUI_MINIMIZE_TRAY),
	GUI_START_MINIMIZED(Page.APPEARANCE, FieldEditorType.DefaultBoolean, Boolean.toString(RouterLoggerGui.Defaults.GUI_START_MINIMIZED)),
	GUI_CONFIRM_CLOSE(Page.APPEARANCE, FieldEditorType.DefaultBoolean, Boolean.toString(CloseMessageBox.Defaults.GUI_CONFIRM_CLOSE)),
	...
	EMAIL_SSL_PORT(Page.EMAIL_ADVANCED, FieldEditorType.FormattedInteger, Integer.toString(EmailSender.Defaults.SSL_PORT), new FieldEditorDataBuilder().integerValidRange(1, 65535).build()),
	...
	EMAIL_MAX_QUEUE_SIZE(Page.EMAIL_ADVANCED, FieldEditorType.ScaleInteger, Byte.toString(EmailSender.Defaults.MAX_QUEUE_SIZE), new FieldEditorDataBuilder().scaleMinimum(1).scaleMaximum(Byte.MAX_VALUE).scalePageIncrement(10).build()),
	...
	SERVER_THREADS(Page.SERVER, FieldEditorType.ScaleInteger, Byte.toString(BaseHttpServer.Defaults.THREADS), new FieldEditorDataBuilder().scaleMinimum(1).scaleMaximum(Byte.MAX_VALUE).scalePageIncrement(010).build(), SERVER_ENABLED),
