...
public class EmailAddressesListEditor extends LocalizedListEditor {
	...
	protected class EmailAddressDialog extends TitleAreaDialog {
		...
		protected void configureShell(final Shell newShell) {
			...
			newShell.setText(Resources.get("lbl.preferences.email.address.title"));
		...
		public void create() {
			super.create();
			setTitle(Resources.get("lbl.preferences.email.address.title"));
			setMessage(Resources.get("lbl.preferences.email.address.message"), IMessageProvider.INFORMATION);
		}
		...
		protected Composite createDialogArea(final Composite parent) {
			...
			labelName.setText(Resources.get("lbl.preferences.email.address.address"));
