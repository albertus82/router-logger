...
public enum RouterLoggerPreference implements Preference {
	...
	LANGUAGE(RouterLoggerPage.GENERAL, ComboFieldEditor.class, new PreferenceDataBuilder().defaultValue(Locale.getDefault().getLanguage()).build(), new FieldEditorDataBuilder().namesAndValues(GeneralPreferencePage.getLanguageComboOptions()).build()),
	LOGGER_ITERATIONS(RouterLoggerPage.GENERAL, IntegerComboFieldEditor.class, new PreferenceDataBuilder().defaultValue(RouterLoggerEngine.Defaults.ITERATIONS).build(), new FieldEditorDataBuilder().namesAndValues(new LocalizedNamesAndValues(new Localized() {
		@Override
	...
	LOGGER_INTERVAL_NORMAL_MS(RouterLoggerPage.GENERAL, FormattedIntegerFieldEditor.class, new PreferenceDataBuilder().defaultValue(RouterLoggerEngine.Defaults.INTERVAL_NORMAL_IN_MILLIS).build()),
	LOGGER_INTERVAL_FAST_MS(RouterLoggerPage.GENERAL, FormattedIntegerFieldEditor.class, new PreferenceDataBuilder().defaultValue(RouterLoggerEngine.Defaults.INTERVAL_FAST_IN_MILLIS).build()),
	LOGGER_HYSTERESIS_MS(RouterLoggerPage.GENERAL, FormattedIntegerFieldEditor.class, new PreferenceDataBuilder().defaultValue(RouterLoggerEngine.Defaults.HYSTERESIS_IN_MILLIS).build()),
	LOGGER_RETRY_COUNT(RouterLoggerPage.GENERAL, IntegerComboFieldEditor.class, new PreferenceDataBuilder().defaultValue(RouterLoggerEngine.Defaults.RETRIES).build(), new FieldEditorDataBuilder().namesAndValues(new LocalizedNamesAndValues(new Localized() {
		@Override
		public String getString() {
			return Resources.get("lbl.preferences.logger.retry.count.infinite");
		}
	}, 0)).build()),
	LOGGER_RETRY_INTERVAL_MS(RouterLoggerPage.GENERAL, FormattedIntegerFieldEditor.class, new PreferenceDataBuilder().defaultValue(RouterLoggerEngine.Defaults.RETRY_INTERVAL_IN_MILLIS).build()),
	LOGGER_ERROR_LOG_DESTINATION_PATH(RouterLoggerPage.GENERAL, FormattedDirectoryFieldEditor.class, new PreferenceDataBuilder().defaultValue(Logger.Defaults.DIRECTORY).build(), new FieldEditorDataBuilder().emptyStringAllowed(false).directoryDialogMessage(new Localized() {
		@Override
		public String getString() {
	...
	READER_CLASS_NAME(RouterLoggerPage.READER, ReaderComboFieldEditor.class, new FieldEditorDataBuilder().namesAndValues(ReaderPreferencePage.getReaderComboOptions()).build()),
	ROUTER_USERNAME(RouterLoggerPage.READER, FormattedStringFieldEditor.class),
	ROUTER_PASSWORD(RouterLoggerPage.READER, PasswordFieldEditor.class),
	ROUTER_ADDRESS(RouterLoggerPage.READER, FormattedStringFieldEditor.class, new PreferenceDataBuilder().defaultValue(Reader.Defaults.ROUTER_ADDRESS).build(), new FieldEditorDataBuilder().emptyStringAllowed(false).build()),
	ROUTER_PORT(RouterLoggerPage.READER, FormattedIntegerFieldEditor.class, new PreferenceDataBuilder().defaultValue(Reader.Defaults.ROUTER_PORT).build(), new FieldEditorDataBuilder().integerValidRange(1, 65535).build()),
	SOCKET_TIMEOUT_MS(RouterLoggerPage.READER, FormattedIntegerFieldEditor.class, new PreferenceDataBuilder().defaultValue(Reader.Defaults.SOCKET_TIMEOUT_IN_MILLIS).build()),
	CONNECTION_TIMEOUT_MS(RouterLoggerPage.READER, FormattedIntegerFieldEditor.class, new PreferenceDataBuilder().defaultValue(Reader.Defaults.CONNECTION_TIMEOUT_IN_MILLIS).build()),
	TELNET_NEWLINE_CHARACTERS(RouterLoggerPage.READER, FormattedComboFieldEditor.class, new PreferenceDataBuilder().defaultValue(Reader.Defaults.TELNET_NEWLINE_CHARACTERS).build(), new FieldEditorDataBuilder().namesAndValues(AbstractPreferencePage.getNewLineComboOptions()).build()),
	...
	READER_WAIT_DISCONNECTED_INTERVAL_THRESHOLD_MS(RouterLoggerPage.READER, FormattedIntegerFieldEditor.class, new PreferenceDataBuilder().defaultValue(RouterLoggerEngine.Defaults.WAIT_DISCONNECTED_INTERVAL_THRESHOLD_IN_MILLIS).parent(READER_WAIT_DISCONNECTED_INTERVAL_THRESHOLD).build()),

	TPLINK_8970_COMMAND_INFO_ADSL(RouterLoggerPage.TPLINK_8970, FormattedStringFieldEditor.class, new PreferenceDataBuilder().defaultValue(TpLink8970Reader.Defaults.COMMAND_INFO_ADSL).build()),
	TPLINK_8970_COMMAND_INFO_WAN(RouterLoggerPage.TPLINK_8970, FormattedStringFieldEditor.class),
	ASUS_DSLN12E_COMMAND_INFO_ADSL(RouterLoggerPage.ASUS_N12E, FormattedStringFieldEditor.class, new PreferenceDataBuilder().defaultValue(AsusDslN12EReader.Defaults.COMMAND_INFO_ADSL).build()),
	ASUS_DSLN12E_COMMAND_INFO_WAN(RouterLoggerPage.ASUS_N12E, FormattedStringFieldEditor.class, new PreferenceDataBuilder().defaultValue(AsusDslN12EReader.Defaults.COMMAND_INFO_WAN).build()),
	ASUS_DSLN14U_COMMAND_INFO_ADSL(RouterLoggerPage.ASUS_N14U, FormattedStringFieldEditor.class, new PreferenceDataBuilder().defaultValue(AsusDslN14UReader.Defaults.COMMAND_INFO_ADSL).build()),
	ASUS_DSLN14U_COMMAND_INFO_WAN(RouterLoggerPage.ASUS_N14U, FormattedStringFieldEditor.class),
	DLINK_2750_COMMAND_INFO_ADSL_STATUS(RouterLoggerPage.DLINK_2750, FormattedStringFieldEditor.class, new PreferenceDataBuilder().defaultValue(DLinkDsl2750Reader.Defaults.COMMAND_INFO_ADSL_STATUS).build()),
	DLINK_2750_COMMAND_INFO_ADSL_SNR(RouterLoggerPage.DLINK_2750, FormattedStringFieldEditor.class, new PreferenceDataBuilder().defaultValue(DLinkDsl2750Reader.Defaults.COMMAND_INFO_ADSL_SNR).build()),

	GUI_TABLE_ITEMS_MAX(RouterLoggerPage.APPEARANCE, FormattedIntegerFieldEditor.class, new PreferenceDataBuilder().defaultValue(DataTable.Defaults.MAX_ITEMS).build(), new FieldEditorDataBuilder().textLimit(4).build()),
	GUI_IMPORTANT_KEYS(RouterLoggerPage.APPEARANCE, WrapStringFieldEditor.class),
	GUI_IMPORTANT_KEYS_SEPARATOR(RouterLoggerPage.APPEARANCE, FormattedStringFieldEditor.class, new PreferenceDataBuilder().defaultValue(RouterLoggerConfiguration.Defaults.GUI_IMPORTANT_KEYS_SEPARATOR).build(), new FieldEditorDataBuilder().emptyStringAllowed(false).build()),
	...
	GUI_CONSOLE_MAX_CHARS(RouterLoggerPage.APPEARANCE, FormattedIntegerFieldEditor.class, new PreferenceDataBuilder().defaultValue(TextConsole.Defaults.GUI_CONSOLE_MAX_CHARS).build(), new FieldEditorDataBuilder().textLimit(6).build()),
	GUI_CLIPBOARD_MAX_CHARS(RouterLoggerPage.APPEARANCE, FormattedIntegerFieldEditor.class, new PreferenceDataBuilder().defaultValue(RouterLoggerGui.Defaults.GUI_CLIPBOARD_MAX_CHARS).build(), new FieldEditorDataBuilder().integerValidRange(0, 128 * 1024).build()),
	...
	CONSOLE_SHOW_KEYS_SEPARATOR(RouterLoggerPage.CONSOLE, FormattedStringFieldEditor.class, new PreferenceDataBuilder().defaultValue(RouterLoggerConfiguration.Defaults.CONSOLE_SHOW_KEYS_SEPARATOR).build(), new FieldEditorDataBuilder().emptyStringAllowed(false).build()),

	WRITER_CLASS_NAME(RouterLoggerPage.WRITER, WriterComboFieldEditor.class, new PreferenceDataBuilder().defaultValue(RouterLoggerEngine.Defaults.WRITER_CLASS.getSimpleName()).build(), new FieldEditorDataBuilder().namesAndValues(WriterPreferencePage.getWriterComboOptions()).build()),

	CSV_DESTINATION_PATH(RouterLoggerPage.CSV, FormattedDirectoryFieldEditor.class, new PreferenceDataBuilder().defaultValue(CsvWriter.Defaults.DIRECTORY).build(), new FieldEditorDataBuilder().emptyStringAllowed(false).directoryDialogMessage(new Localized() {
		@Override
		public String getString() {
			return Resources.get("msg.preferences.directory.dialog.message.csv");
		}
	}).build()),
	CSV_NEWLINE_CHARACTERS(RouterLoggerPage.CSV, FormattedComboFieldEditor.class, new PreferenceDataBuilder().defaultValue(CsvWriter.Defaults.NEWLINE.name()).build(), new FieldEditorDataBuilder().namesAndValues(AbstractPreferencePage.getNewLineComboOptions()).build()),
	CSV_FIELD_SEPARATOR(RouterLoggerPage.CSV, DelimiterComboFieldEditor.class, new PreferenceDataBuilder().defaultValue(CsvWriter.Defaults.FIELD_SEPARATOR).build(), new FieldEditorDataBuilder().emptyStringAllowed(false).namesAndValues(CsvPreferencePage.getSeparatorComboOptions()).build()),
	CSV_FIELD_SEPARATOR_REPLACEMENT(RouterLoggerPage.CSV, FormattedStringFieldEditor.class, new PreferenceDataBuilder().defaultValue(CsvWriter.Defaults.FIELD_SEPARATOR_REPLACEMENT).build(), new FieldEditorDataBuilder().emptyStringAllowed(false).build()),
	...
	DATABASE_DRIVER_CLASS_NAME(RouterLoggerPage.DATABASE, DatabaseComboFieldEditor.class, new FieldEditorDataBuilder().namesAndValues(DatabasePreferencePage.getDatabaseComboOptions()).build()),
	DATABASE_URL(RouterLoggerPage.DATABASE, FormattedStringFieldEditor.class),
	DATABASE_USERNAME(RouterLoggerPage.DATABASE, FormattedStringFieldEditor.class),
	DATABASE_PASSWORD(RouterLoggerPage.DATABASE, PasswordFieldEditor.class),
	DATABASE_TABLE_NAME(RouterLoggerPage.DATABASE, FormattedStringFieldEditor.class, new PreferenceDataBuilder().defaultValue(DatabaseWriter.Defaults.TABLE_NAME).build(), new FieldEditorDataBuilder().emptyStringAllowed(false).build()),
	DATABASE_CONNECTION_VALIDATION_TIMEOUT_MS(RouterLoggerPage.DATABASE, FormattedIntegerFieldEditor.class, new PreferenceDataBuilder().defaultValue(DatabaseWriter.Defaults.CONNECTION_VALIDATION_TIMEOUT_IN_MILLIS).build(), new FieldEditorDataBuilder().textLimit(5).build()),
	DATABASE_TIMESTAMP_COLUMN_TYPE(RouterLoggerPage.DATABASE, FormattedStringFieldEditor.class, new PreferenceDataBuilder().defaultValue(DatabaseWriter.Defaults.TIMESTAMP_COLUMN_TYPE).build(), new FieldEditorDataBuilder().emptyStringAllowed(false).build()),
	DATABASE_RESPONSE_COLUMN_TYPE(RouterLoggerPage.DATABASE, FormattedStringFieldEditor.class, new PreferenceDataBuilder().defaultValue(DatabaseWriter.Defaults.RESPONSE_TIME_COLUMN_TYPE).build(), new FieldEditorDataBuilder().emptyStringAllowed(false).build()),
	DATABASE_INFO_COLUMN_TYPE(RouterLoggerPage.DATABASE, FormattedStringFieldEditor.class, new PreferenceDataBuilder().defaultValue(DatabaseWriter.Defaults.INFO_COLUMN_TYPE).build(), new FieldEditorDataBuilder().emptyStringAllowed(false).build()),
	DATABASE_COLUMN_NAME_PREFIX(RouterLoggerPage.DATABASE, FormattedStringFieldEditor.class, new PreferenceDataBuilder().defaultValue(DatabaseWriter.Defaults.COLUMN_NAME_PREFIX).build(), new FieldEditorDataBuilder().emptyStringAllowed(false).build()),
	DATABASE_COLUMN_NAME_MAX_LENGTH(RouterLoggerPage.DATABASE, FormattedIntegerFieldEditor.class, new PreferenceDataBuilder().defaultValue(DatabaseWriter.Defaults.COLUMN_NAME_MAX_LENGTH).build(), new FieldEditorDataBuilder().textLimit(2).build()),
	...
	THRESHOLDS_EMAIL_SEND_INTERVAL_SECS(RouterLoggerPage.THRESHOLDS, FormattedIntegerFieldEditor.class, new PreferenceDataBuilder().defaultValue(ThresholdsEmailSender.Defaults.THRESHOLDS_EMAIL_SEND_INTERVAL_SECS).parent(THRESHOLDS_EMAIL).build()),
	THRESHOLDS_EMAIL_MAX_ITEMS(RouterLoggerPage.THRESHOLDS, FormattedIntegerFieldEditor.class, new PreferenceDataBuilder().defaultValue(ThresholdsEmailSender.Defaults.MAX_ITEMS).parent(THRESHOLDS_EMAIL).build(), new FieldEditorDataBuilder().integerValidRange(1, 1000).build()),
	THRESHOLDS_EXCLUDED(RouterLoggerPage.THRESHOLDS, WrapStringFieldEditor.class),
	THRESHOLDS_EXCLUDED_SEPARATOR(RouterLoggerPage.THRESHOLDS, FormattedStringFieldEditor.class, new PreferenceDataBuilder().defaultValue(RouterLoggerConfiguration.Defaults.THRESHOLDS_EXCLUDED_SEPARATOR).build(), new FieldEditorDataBuilder().emptyStringAllowed(false).build()),

	EMAIL_HOST(RouterLoggerPage.EMAIL, FormattedStringFieldEditor.class),
	EMAIL_USERNAME(RouterLoggerPage.EMAIL, FormattedStringFieldEditor.class),
	EMAIL_PASSWORD(RouterLoggerPage.EMAIL, PasswordFieldEditor.class),
	EMAIL_FROM_NAME(RouterLoggerPage.EMAIL, FormattedStringFieldEditor.class),
	EMAIL_FROM_ADDRESS(RouterLoggerPage.EMAIL, FormattedStringFieldEditor.class),
	...
	EMAIL_PORT(RouterLoggerPage.EMAIL_ADVANCED, FormattedIntegerFieldEditor.class, new PreferenceDataBuilder().defaultValue(EmailSender.Defaults.PORT).build(), new FieldEditorDataBuilder().integerValidRange(1, 65535).build()),
	EMAIL_SSL_PORT(RouterLoggerPage.EMAIL_ADVANCED, FormattedIntegerFieldEditor.class, new PreferenceDataBuilder().defaultValue(EmailSender.Defaults.SSL_PORT).build(), new FieldEditorDataBuilder().integerValidRange(1, 65535).build()),
	EMAIL_CONNECTION_TIMEOUT(RouterLoggerPage.EMAIL_ADVANCED, FormattedIntegerFieldEditor.class, new PreferenceDataBuilder().defaultValue(EmailSender.Defaults.SOCKET_CONNECTION_TIMEOUT).build()),
	EMAIL_SOCKET_TIMEOUT(RouterLoggerPage.EMAIL_ADVANCED, FormattedIntegerFieldEditor.class, new PreferenceDataBuilder().defaultValue(EmailSender.Defaults.SOCKET_TIMEOUT).build()),
	EMAIL_RETRY_INTERVAL_SECS(RouterLoggerPage.EMAIL_ADVANCED, FormattedIntegerFieldEditor.class, new PreferenceDataBuilder().defaultValue(EmailSender.Defaults.RETRY_INTERVAL_SECS).build()),
	EMAIL_MAX_SENDINGS_PER_CYCLE(RouterLoggerPage.EMAIL_ADVANCED, IntegerComboFieldEditor.class, new PreferenceDataBuilder().defaultValue(EmailSender.Defaults.MAX_SENDINGS_PER_CYCLE).build(), new FieldEditorDataBuilder().namesAndValues(new LocalizedNamesAndValues(new Localized() {
		@Override
		public String getString() {
	...
	SERVER_PORT(RouterLoggerPage.SERVER, FormattedIntegerFieldEditor.class, new PreferenceDataBuilder().defaultValue(BaseHttpServer.Defaults.PORT).restartRequired().parent(SERVER_ENABLED).build(), new FieldEditorDataBuilder().integerValidRange(1, 65535).build()),
	...
	SERVER_USERNAME(RouterLoggerPage.SERVER, FormattedStringFieldEditor.class, new PreferenceDataBuilder().parent(SERVER_AUTHENTICATION).build()),
	...
	SERVER_LOG_REQUEST(RouterLoggerPage.SERVER, FormattedComboFieldEditor.class, new PreferenceDataBuilder().defaultValue(BaseHtmlHandler.Defaults.LOG_REQUEST).parent(SERVER_ENABLED).build(), new FieldEditorDataBuilder().namesAndValues(ServerPreferencePage.getLogComboOptions()).build()),
	...
	SERVER_SSL_KEYSTORE_FILE(RouterLoggerPage.SERVER_HTTPS, FormattedFileFieldEditor.class, new PreferenceDataBuilder().restartRequired().parent(SERVER_SSL_ENABLED).build(), new FieldEditorDataBuilder().fileExtensions(ServerHttpsPreferencePage.getKeyStoreFileExtensions()).build()),
	...
	MQTT_USERNAME(RouterLoggerPage.MQTT, FormattedStringFieldEditor.class, new PreferenceDataBuilder().restartRequired().parent(MQTT_ENABLED).build()),
	...
	MQTT_CLIENT_ID(RouterLoggerPage.MQTT, FormattedStringFieldEditor.class, new PreferenceDataBuilder().restartRequired().defaultValue(RouterLoggerMqttClient.Defaults.CLIENT_ID).parent(MQTT_ENABLED).build(), new FieldEditorDataBuilder().emptyStringAllowed(false).build()),
	...
	MQTT_DATA_TOPIC(RouterLoggerPage.MQTT_MESSAGES, FormattedStringFieldEditor.class, new PreferenceDataBuilder().defaultValue(RouterLoggerMqttClient.Defaults.DATA_TOPIC).parent(MQTT_DATA_ENABLED).build(), new FieldEditorDataBuilder().emptyStringAllowed(false).build()),
	MQTT_DATA_QOS(RouterLoggerPage.MQTT_MESSAGES, FormattedComboFieldEditor.class, new PreferenceDataBuilder().defaultValue(RouterLoggerMqttClient.Defaults.DATA_QOS).parent(MQTT_DATA_ENABLED).build(), new FieldEditorDataBuilder().namesAndValues(MqttPreferencePage.getMqttQosComboOptions()).build()),
	MQTT_DATA_THROTTLING_MS(RouterLoggerPage.MQTT_MESSAGES, IntegerComboFieldEditor.class, new PreferenceDataBuilder().defaultValue(RouterLoggerMqttClient.Defaults.DATA_THROTTLING_IN_MILLIS).parent(MQTT_DATA_ENABLED).build(), new FieldEditorDataBuilder().namesAndValues(new LocalizedNamesAndValues(new Localized() {
		@Override
		public String getString() {
	...
	MQTT_STATUS_TOPIC(RouterLoggerPage.MQTT_MESSAGES, FormattedStringFieldEditor.class, new PreferenceDataBuilder().restartRequired().defaultValue(RouterLoggerMqttClient.Defaults.STATUS_TOPIC).parent(MQTT_STATUS_ENABLED).build(), new FieldEditorDataBuilder().emptyStringAllowed(false).build()),
	MQTT_STATUS_QOS(RouterLoggerPage.MQTT_MESSAGES, FormattedComboFieldEditor.class, new PreferenceDataBuilder().restartRequired().defaultValue(RouterLoggerMqttClient.Defaults.STATUS_QOS).parent(MQTT_STATUS_ENABLED).build(), new FieldEditorDataBuilder().namesAndValues(MqttPreferencePage.getMqttQosComboOptions()).build()),
	...
	MQTT_THRESHOLDS_TOPIC(RouterLoggerPage.MQTT_MESSAGES, FormattedStringFieldEditor.class, new PreferenceDataBuilder().defaultValue(RouterLoggerMqttClient.Defaults.THRESHOLDS_TOPIC).parent(MQTT_THRESHOLDS_ENABLED).build(), new FieldEditorDataBuilder().emptyStringAllowed(false).build()),
	MQTT_THRESHOLDS_QOS(RouterLoggerPage.MQTT_MESSAGES, FormattedComboFieldEditor.class, new PreferenceDataBuilder().defaultValue(RouterLoggerMqttClient.Defaults.THRESHOLDS_QOS).parent(MQTT_THRESHOLDS_ENABLED).build(), new FieldEditorDataBuilder().namesAndValues(MqttPreferencePage.getMqttQosComboOptions()).build()),
	...
	MQTT_CONNECTION_TIMEOUT(RouterLoggerPage.MQTT_ADVANCED, FormattedIntegerFieldEditor.class, new PreferenceDataBuilder().restartRequired().defaultValue(RouterLoggerMqttClient.Defaults.CONNECTION_TIMEOUT).parent(MQTT_ENABLED).build()),
	MQTT_KEEP_ALIVE_INTERVAL(RouterLoggerPage.MQTT_ADVANCED, FormattedIntegerFieldEditor.class, new PreferenceDataBuilder().restartRequired().defaultValue(RouterLoggerMqttClient.Defaults.KEEP_ALIVE_INTERVAL).parent(MQTT_ENABLED).build()),
	MQTT_MAX_INFLIGHT(RouterLoggerPage.MQTT_ADVANCED, FormattedIntegerFieldEditor.class, new PreferenceDataBuilder().restartRequired().defaultValue(RouterLoggerMqttClient.Defaults.MAX_INFLIGHT).parent(MQTT_ENABLED).build()),
	MQTT_VERSION(RouterLoggerPage.MQTT_ADVANCED, FormattedComboFieldEditor.class, new PreferenceDataBuilder().restartRequired().defaultValue(RouterLoggerMqttClient.Defaults.MQTT_VERSION).parent(MQTT_ENABLED).build(), new FieldEditorDataBuilder().namesAndValues(AdvancedMqttPreferencePage.getMqttVersionComboOptions()).build()),
	...
	MQTT_PERSISTENCE_FILE_PATH(RouterLoggerPage.MQTT_ADVANCED, FormattedDirectoryFieldEditor.class, new PreferenceDataBuilder().restartRequired().defaultValue(System.getProperty("user.dir")).parent(MQTT_PERSISTENCE_FILE_CUSTOM).build(), new FieldEditorDataBuilder().emptyStringAllowed(false).directoryDialogMessage(new Localized() {
		@Override
		public String getString() {
